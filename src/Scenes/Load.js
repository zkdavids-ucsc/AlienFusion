class Load extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image("beigeAlien", "alienBeige.png");
        this.load.image("blueAlien", "alienBlue.png");
        this.load.image("greenAlien", "alienGreen.png");
        this.load.image("pinkAlien", "alienPink.png");
        this.load.image("yellowAlien", "alienYellow.png");
        this.load.image("particle", "5x5_white.png");

        this.load.audio("score", "confirmation_002.ogg");
